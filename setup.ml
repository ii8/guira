...
(* OASIS_START *)
(* DO NOT EDIT (digest: 10b9c491c2568f042d1d407bea6c6df5) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("functional",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test.scm", ["$guira"]))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Murray <murray.calavera@gmail.com>"];
          homepage = None;
          synopsis = "s-expression language to query dates";
          description = None;
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Create javascript library";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Guira"];
                      lib_pack = false;
                      lib_internal_modules = ["Syntax"; "Filter"; "Sexp"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "javascript.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, ["-safe-string"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-safe-string"])]
                   },
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "guira"]
                   });
               SrcRepo
                 ({
                     cs_name = "github";
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/sir-murray/guira.git";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\127?\143|\"\152\030\r…Ù\140Í∑\031¶\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
